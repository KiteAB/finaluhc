...
give @a golden_apple 32
give @a fishing_rod{Unbreakable: true} 1
give @a enchanted_golden_apple{display: {Name: '["Golden Head"]'}} 8
give @a water_bucket 1
give @a bow{Enchantments: [{id: "minecraft:power", lvl: 3}]} 1
give @a lava_bucket 1

give @a water_bucket 2
give @a lava_bucket 2
give @a arrow 16
...
give @a diamond_leggings{Enchantments: [{id: "minecraft:protection", lvl: 2}]} 1
give @a diamond_boots{Enchantments: [{id: "minecraft:protection", lvl: 2}]} 1
